...
class CollegeCtl(BaseCtl):
    ...
    def input_validation(self):
        ...
        if (DataValidator.isNull(self.form['collegePhoneNumber'])):
            inputError['collegePhoneNumber'] = "College PhoneNo. can not be null"
            self.form["error"] = True
        else:
            if (DataValidator.ismobilecheck(self.form['collegePhoneNumber'])):
                inputError['collegePhoneNumber'] = "Numbers allowed which starts with 6,7,8,9"
                self.form["error"] = True
